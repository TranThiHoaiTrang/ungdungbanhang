            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        ?>
                            <li class="nav-item">
                                <a class="nav-link" href="category.php?id=<?php echo $item['id']; ?>"><?php echo $item['categories_name']; ?></a>
                            </li>
                        <?php
                        }
                        ?>
                        ...
                        <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                            <div class="single-product-wrapper">
                                ...
                                <div class="product-img">
                                    <a href="product-detailsID.php?idProduct=<?php echo $item['id']; ?>">
                                        <img src="img/bg-img/<?php echo $item['product_img'] ?>" class="card-img-top" alt="...">
                                    </a>
                                </div>
                                ...
                                <div class="product-description d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="product-meta-data">
                                        ...
                                        <h6 class="clsh6"><a href="product-details.php"><?php echo $item['product_name'] ?></a></h6>
                                    </div>
                                    <!-- Ratings & Cart -->
                                    <div class="ratings-cart text-right">
                                        ...
                                        <div class="cart">
                                            <a href="product-detailsID.php?idProduct=<?php echo $item['id']; ?>" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="img/core-img/cart.png" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
