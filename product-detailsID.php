...
$productview = $productModel->getProductByIdview($idProduct); 

if(!isset($_SESSION['id'][$idProduct]))
{
    $product_view = $item['product_view'];
    $product_view++;
    $productModel->getview($idProduct,$product_view);
    $_SESSION['id'][$idProduct]=$product_view;
    header("location:product-detailsID.php?idProduct=$idProduct");
}
...
<head>
    ...
    <!-- Title  -->
    <title>Amado - Furniture Ecommerce Template | Product Details ID</title>
                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active" herf="product-detailsID.php?idProduct=<?php echo $item['id']; ?>">
                                        <a class="gallery_img">
                                            <img class="d-block w-100" src="img/bg-img/<?php echo $item['product_img'] ?>" alt="First slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                ...
                                <p>View: <span><?php echo $item['product_view'] ?></span></p>
                                <a href="product-detailsID.php">
                            ...
                            <!-- Add to Cart Form -->
                            <form class="cart clearfix" action="insertCart.php?id=<?php echo $item['id'] ?>" method="post">
                                ...
                                <div class="login">
                                    ...
                                    if (isset($_SESSION['username']) && $_SESSION['username']) {
                                    ?>
                                        <button onclick="addCart(<?php echo $item['id'] ?>)" type="submit" name="addtocart" value="mua hang" class="btn amado-btn" target="_blank">Add to cart</button>
                                    <?php
                                    } else { ?>
                                        <li>Đăng Nhập Để Được Mua Những Món Đồ Yêu Thích Nhá</li>
                                        <a href="login.php">
                                            <li>Login</li>
                                        </a>
                                    <?php
